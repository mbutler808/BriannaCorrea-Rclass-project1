...
*As stated above this project is in processing. Therefore as of 4/1/2025 please look only in Code and Data for any relevant changes. As of 4/6/2025 files avaliable are all active. We are currently in the later phase of the project analysis wherein we will be able to answer questions utilizing our cleaned data and create a valuable discussion surrounding findings. 
