...
data_location <- "C:/Users/brnna/classbutler/Homework/BriannaCorrea-Rclass-project1/Data/Raw_data/penguins_raw_dirty.csv
...
penguin_raw <- read.csv(data_location, check.names=FALSE)
 ...
 #Looks in data location we set, check.names=FALSE prevents R from changing stuff, read.csv() reads my csv files that I connected to data location

```


#Check data
##Help visualize and check data set
...
# Check how many NAs are in each column of the dataset

skim(penguin_raw)
#Use to summarize the dataset as is
